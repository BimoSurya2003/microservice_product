...
import 'package:microservice_product/model/model_detail_product.dart';
  ...
  Future<void> fetchReviews(int productId) async {
    try {
      final response = await http.get(
          Uri.parse('http://192.168.125.134:3003/products/$productId/reviews'));
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'lib/assets/product.jpg', // Pastikan path file gambar sudah benar
                                    ...
                                    children: List.generate(5, (starIndex) {
                                      ...
                                      return Icon(
                                        starIndex < review.review.ratings
                                            ? Icons.star
                                            : Icons
                                                .star_border, // Bintang kosong jika tidak sesuai rating
                                        color: Colors.orange, // Warna bintang
